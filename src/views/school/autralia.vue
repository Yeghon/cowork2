      ...
      <div class="container-medium pt-5 pb-5 page-intro">
        <div class="row py-5">
          <div class="col-lg-5 order-lg-2 pt-4">
            <div class="max-text mx-auto">
              <nav aria-label="breadcrumb" class="breadcrumb_nav mb-3" typeof="BreadcrumbList"
                  ...
                  property="name">Austria</span><meta property="position" content="3"></span></nav>
              <div class="line"></div>
              <h1 class="mt-2">Talent Garden Innovation School <span class="orange">Austria</span></h1>
              <p>Talent Garden Innovation School Vienna is an innovative educational institute that uses a disruptive
                learning approach that puts people at the centre through a cutting-edge training methodology. We deliver
                in-depth courses and training programs for both individuals and companies, focusing on five key areas
                coding, data, marketing, design and business. We offer Bootcamps, Digital Transformation Programs and
                Masterclasses in digital technologies and innovation fields.</p> <a href="#course"
          ...
          <div class="col-lg-7 mt-lg-0 mt-5 order-lg-1 pr-lg-5"><img class="w-100 d-block"
                                                                     src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2020/11/Hero_Image_Talent_Garden_Zoom_Background_3-900x720.jpg"
                                                                     alt=""></div>
        </div>
      </div>
      <div class="bg-light py-5" id="course">
        <div class="container py-5">
          <div class="col-12">
            ...
            <div class="mt-5 container-filter" id="MixItUpFE63C6">
                ...
                <div class="row align-items-center py-1">
                  <div class="col-lg-7 mb-lg-0 mb-4 pb-lg-0 pb-4">
                    <div class="type d-inline-block mr-2 font-weight-bold text-uppercase text-primary"
                         style="font-size:12px; letter-spacing:2px">Austria
                    </div>
                    <h4 class="black lubalin font-weight-bold mb-0 font-size-24 d-block my-2">UX Design Bootcamp</h4>
                    <span class="black"><div
                        class="lang d-inline-block px-2 border mr-2 font-weight-medium text-uppercase"
                        style="font-size:12px; letter-spacing:1px; padding-top:2px">English</div> Vienna </span></div>
                  <div
                      class="col-lg-2 col-sm-6 mb-sm-0 mb-4 text-center border-left d-sm-block d-flex align-items-center">
                    <span class="primary d-block mb-0">03.11.2021</span> <span
      ...
      <div class="pt-5 mt-5">
        ...
        <div class="container block-text pb-5 mb-5" id="row-1">
          <div class="row justify-content-between align-items-center">
            <div class="col-md-5 order-md-2 pl-md-5"><h2 class="mb-3">Talent acquisition for companies</h2>
              <p>With our Talent Garden Innovation School leading-edge hiring services, you can cultivate the talent
                your company needs to thrive.</p>
              <ul class="list-unstyled media-list">
                <li class="media border-bottom py-2 align-items-center"><span
                  ...
                  <div class="media-body"><p class="mb-0">Connect with expert-trained, job-ready candidates from our
                    rigorous coding, data, business, marketing and design courses.</p></div>
                </li>
                <li class="media border-bottom py-2 align-items-center"><span
                    class="mr-3 text-primary font-weight-bold  text-center">2</span>
                  <div class="media-body"><p class="mb-0">Create custom hiring programs and different roles
                    simultaneously, at a lower cost</p></div>
                </li>
                <li class="media border-bottom py-2 align-items-center"><span
                    class="mr-3 text-primary font-weight-bold  text-center">3</span>
                  <div class="media-body"><p class="mb-0">Expand diversity initiatives and encourage a culture of
                    inclusion and innovation</p></div>
                </li>
              </ul>
            </div>
            <div class="col-md-7 order-md-1 mt-md-0 mt-5"><img class="w-100"
                                                               src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2020/11/Talent_Garden_Zoom_Background_7-900x720.jpg"
                                                               alt=""></div>
          </div>
        </div>
            ...
            <div class="col-md-12">
              <ul class="list-unstyled row logos justify-content-start">
                <li class="col-lg-2 col-md-4 col-6 mb-md-5 text-center mb-md-0 mb-5"><img
                    src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2019/10/1000things.jpg"
                    alt="" class="mx-auto"></li>
                <li class="col-lg-2 col-md-4 col-6 mb-md-5 text-center mb-md-0 mb-5"><img
                    src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2019/10/AT-placement-partners-1.png"
                    alt="" class="mx-auto"></li>
                <li class="col-lg-2 col-md-4 col-6 mb-md-5 text-center mb-md-0 mb-5"><img
                    src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2020/05/Amazon_Web_Services_Logo.svg.png"
                    alt="" class="mx-auto"></li>
                <li class="col-lg-2 col-md-4 col-6 mb-md-5 text-center mb-md-0 mb-5"><img
                    src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2019/10/Bank-AT.png"
                    alt="" class="mx-auto"></li>
                <li class="col-lg-2 col-md-4 col-6 mb-md-5 text-center mb-md-0 mb-5"><img
                    src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2020/10/GainerFestival_LogoBunt.png"
                    alt="" class="mx-auto"></li>
                <li class="col-lg-2 col-md-4 col-6 mb-md-5 text-center mb-md-0 mb-5"><img
                    src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2020/10/Logo_HG_Farbe.png"
                    alt="" class="mx-auto"></li>
                <li class="col-lg-2 col-md-4 col-6 mb-md-5 text-center mb-md-0 mb-5"><img
                    src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2020/10/INDEEWORK_Logo_Color.jpg"
                    alt="" class="mx-auto"></li>
                <li class="col-lg-2 col-md-4 col-6 mb-md-5 text-center mb-md-0 mb-5"><img
                    src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2020/10/Industrie-Magazin-Logo.jpg"
                    alt="" class="mx-auto"></li>
                <li class="col-lg-2 col-md-4 col-6 mb-md-5 text-center mb-md-0 mb-5"><img
                    src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2019/10/Jhornig.png"
                    alt="" class="mx-auto"></li>
                <li class="col-lg-2 col-md-4 col-6 mb-md-5 text-center mb-md-0 mb-5"><img
                    src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2020/10/J-ITGesmbH.png"
                    alt="J-IT GesmbH" class="mx-auto"></li>
                <li class="col-lg-2 col-md-4 col-6 mb-md-5 text-center mb-md-0 mb-5"><img
                    src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2019/10/Lympik.png"
                    alt="" class="mx-auto"></li>
                <li class="col-lg-2 col-md-4 col-6 mb-md-5 text-center mb-md-0 mb-5"><img
                    src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2020/10/mysugr-logo-color.png"
                    alt="" class="mx-auto"></li>
                <li class="col-lg-2 col-md-4 col-6 mb-md-5 text-center mb-md-0 mb-5"><img
                    src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2020/10/Logo_nexxar_green_back.png"
                    alt="" class="mx-auto"></li>
                <li class="col-lg-2 col-md-4 col-6 mb-md-5 text-center mb-md-0 mb-5"><img
                    src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2019/10/Novomatic.png"
                    alt="" class="mx-auto"></li>
                <li class="col-lg-2 col-md-4 col-6 mb-md-5 text-center mb-md-0 mb-5"><img
                    src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2019/10/Lottrerien.png"
                    alt="" class="mx-auto"></li>
                <li class="col-lg-2 col-md-4 col-6 mb-md-5 text-center mb-md-0 mb-5"><img
                    src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2019/10/AT-placement-partners-1-copy.png"
                    alt="" class="mx-auto"></li>
                <li class="col-lg-2 col-md-4 col-6 mb-md-5 text-center mb-md-0 mb-5"><img
                    src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2019/10/Postando.png"
                    alt="" class="mx-auto"></li>
                <li class="col-lg-2 col-md-4 col-6 mb-md-5 text-center mb-md-0 mb-5"><img
                    src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2019/10/RBI.png"
                    alt="" class="mx-auto"></li>
                <li class="col-lg-2 col-md-4 col-6 mb-md-5 text-center mb-md-0 mb-5"><img
                    src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2020/10/thefemalefactor_logo.png"
                    alt="" class="mx-auto"></li>
                <li class="col-lg-2 col-md-4 col-6 mb-md-5 text-center mb-md-0 mb-5"><img
                    src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2019/10/Tour-Radar.png"
                    alt="" class="mx-auto"></li>
                <li class="col-lg-2 col-md-4 col-6 mb-md-5 text-center mb-md-0 mb-5"><img
                    src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2020/10/VieSure_Logo.png"
                    alt="" class="mx-auto"></li>
                <li class="col-lg-2 col-md-4 col-6 mb-md-5 text-center mb-md-0 mb-5"><img
                    src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2020/10/Logo_WU_ExecutiveAcademy.png"
                    alt="" class="mx-auto"></li>
              </ul>
            </div>
          </div>
        ...
        <div class="bg-primary" id="manager">
          <div class="container py-5" id="row-3">
            <div class="row align-items-center">
              <div class="col-md-6"><h2 class="white">Meet our team</h2>
                <p><span style="font-weight: 400;">Graduated in Communication Sciences for institutions and companies at the University of Turin, Giulia Amico di Meane has gained decades of experience in FCA (Fiat Chrysler Automobiles), covering various managerial roles over the years. She began her career in FCA in Commercial Training, managing the launch of new products for all the brands in the group. Her experience continues as EMEA Product Marketing Manager for Fiat Panda, before becoming Fiat Brand’s Innovation &amp; Customer Experience Manager.</span>
                </p></div>
              <div class="col-md-5 ml-auto text-center profile">
                <div class="avatar d-block mx-auto mb-3"><img class="align-self-center"
                                                              src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2019/09/giulia-amico.jpg"
                                                              alt=""></div>
                <p class="white text-center d-block"><strong class="white lubalin font-size-18">Giulia Amico di
                  Meane</strong><br> <em class="white">Talent Garden Innovation School Director</em></p></div>
            </div>
          </div>
        </div>
      </div>
      <div class="mappa bg-light">
        <div class="row align-items-center mx-0">
          <div class="col-lg-5 col-md-6 py-5 order-md-2 px-5"><h3 class="mb-3">Talent Garden<br> Innovation School<br>
            ...
            <div class="d-block py-2 border-bottom mb-2"><span
                class="font-weight-bold black mb-0">Talent Garden Vienna</span>
              <p class="mb-0">Liechtensteinstraße 111-115, 1090 Wien - Austria</p></div>
          </div>
                    ...
                    <div
                      ...
                      <div style="position: absolute; left: 0px; top: 0px; z-index: 100; width: 100%;">
                        <div style="position: absolute; left: 0px; top: 0px; z-index: 0;">
                          <div style="position: absolute; z-index: 995; transform: matrix(1, 0, 0, 1, -116, -24);">
                      ...
                      <div style="position: absolute; left: 0px; top: 0px; z-index: 0;">
                        <div style="position: absolute; z-index: 995; transform: matrix(1, 0, 0, 1, -116, -24);">
                          ...
                          <div
                            ...
                            <img draggable="false" alt="" role="presentation"
                                 src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i5!2i16!3i9!4i256!2m3!1e0!2sm!3i566292796!3m17!2sen-US!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!!4e0&amp;key=AIzaSyD3qp2b1oSi_PIiA-ta0foe-RGzAzax5XM&amp;token=130072"
                                 style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                          </div>
                          <div
                              style="position: absolute; left: -512px; top: -512px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                            <img draggable="false" alt="" role="presentation"
                                 src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i5!2i15!3i9!4i256!2m3!1e0!2sm!3i566292796!3m17!2sen-US!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!!4e0&amp;key=AIzaSyD3qp2b1oSi_PIiA-ta0foe-RGzAzax5XM&amp;token=120879"
                                 style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                          </div>
                          <div
                              style="position: absolute; left: 256px; top: -512px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                            <img draggable="false" alt="" role="presentation"
                                 src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i5!2i18!3i9!4i256!2m3!1e0!2sm!3i566292796!3m17!2sen-US!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!!4e0&amp;key=AIzaSyD3qp2b1oSi_PIiA-ta0foe-RGzAzax5XM&amp;token=17387"
                                 style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                          </div>
                          <div
                              style="position: absolute; left: 0px; top: -512px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                            <img draggable="false" alt="" role="presentation"
                                 src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i5!2i17!3i9!4i256!2m3!1e0!2sm!3i566292796!3m17!2sen-US!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!!4e0&amp;key=AIzaSyD3qp2b1oSi_PIiA-ta0foe-RGzAzax5XM&amp;token=8194"
                                 style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="gmnoprint"
                      ...
                      <div class="gm-style-mtc" style="float: left; position: relative;">
                        <button draggable="false" aria-label="Show street map" title="Show street map" type="button"
                                aria-pressed="true" id="36F66B53-255A-4AF5-A44F-3371379144D3" aria-expanded="false"
                        ...
                        <ul role="menu" aria-labelledby="36F66B53-255A-4AF5-A44F-3371379144D3"
                      ...
                      <div class="gm-style-mtc" style="float: left; position: relative;">
                        <button draggable="false" aria-label="Show satellite imagery" title="Show satellite imagery"
                                type="button" aria-pressed="false" id="6561AAA4-5248-4661-8518-8BB2D3E8EA62"
                                aria-expanded="false"
                        ...
                        <ul role="menu" aria-labelledby="6561AAA4-5248-4661-8518-8BB2D3E8EA62"
                  ...
                  <div>
                    <div
                      ...
                      <a target="_blank" rel="noopener"
                         href="https://maps.google.com/maps?ll=48.228423,16.35373&amp;z=5&amp;t=m&amp;hl=en-US&amp;gl=US&amp;mapclient=apiv3"
                    ...
                    <div draggable="false" class="gm-style-cc"
                      ...
                      <div
                        ...
                        <a target="_blank" rel="noopener" title="Report errors in the road map or imagery to Google"
                           dir="ltr"
                           href="https://www.google.com/maps/@48.2284233,16.3537297,5z/data=!10m1!1e1!12b1?source=apiv3&amp;rapsrc=apiv3"
