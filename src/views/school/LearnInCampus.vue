<template>
  <div>
    <navigation/>
    <main>
      <div class="container-medium pt-5 pb-5 page-intro">
        <div class="row py-5">
          <div class="col-lg-5 order-lg-2 pt-4">
            <div class="max-text mx-auto">
              <nav aria-label="breadcrumb" class="breadcrumb_nav mb-3" typeof="BreadcrumbList"
                  ...
                  property="name">Nairobi</span><meta property="position" content="3"></span></nav>
              <div class="line"></div>
              <h1 class="mt-2">Talent Garden Innovation School <span class="orange">Nairobi</span></h1>
      ...
      <div class="bg-light py-5" id="course">
        <div class="container py-5">
          <div class="col-12">
            ...
            <form class="controls row my-5 align-items-center">
            ...
            <div v-for="course in courses" :key="course" class="mt-5 container-filter" id="MixItUp8E8326">
                ...
                <div class="row align-items-center py-1">
                  <div class="col-lg-7 mb-lg-0 mb-4 pb-lg-0 pb-4">
                    <div class="type d-inline-block mr-2 font-weight-bold text-uppercase text-primary"
                         style="font-size:12px; letter-spacing:2px">Kenya
                    </div>
                    <h4 class="black lubalin font-weight-bold mb-0 font-size-24 d-block my-2">{{ course.name }}
              ...
              <!--                  <div class="col-lg-7 mb-lg-0 mb-4 pb-lg-0 pb-4">-->
              <!--                    <div class="type d-inline-block mr-2 font-weight-bold text-uppercase text-primary"-->
              <!--                         style="font-size:12px; letter-spacing:2px">Italy-->
              <!--                    </div>-->
              <!--                    <h4 class="black lubalin font-weight-bold mb-0 font-size-24 d-block my-2">Percorso Executive in Data-->
              <!--                      Driven Business Transformation</h4> <span class="black"><div-->
              <!--                      class="lang d-inline-block px-2 border mr-2 font-weight-medium text-uppercase"-->
              <!--                      style="font-size:12px; letter-spacing:1px; padding-top:2px">Italian</div> Roma </span></div>-->
              <!--                  <div-->
              <!--                      class="col-lg-2 col-sm-6 mb-sm-0 mb-4 text-center border-left d-sm-block d-flex align-items-center">-->
              <!--                    <span class="primary d-block mb-0">07.02.2022</span> <span-->
              <!--                      class="black lett-space-2 font-size-12 text-uppercase ml-auto"></span></div>-->
              <!--                  <div class="col-lg-3 col-sm-6"><span class="btn btn-primary d-block py-3">Learn more</span></div>-->
              <!--                </div>-->
              <!--              </a></div>-->
              ...
              <!--                         style="font-size:12px; letter-spacing:2px">Italy-->
              <!--                    </div>-->
              <!--                    <h4 class="black lubalin font-weight-bold mb-0 font-size-24 d-block my-2">Digital Business Strategy-->
              <!--                      – Major del Master in Management and Technology</h4> <span class="black"><div-->
              <!--                      class="lang d-inline-block px-2 border mr-2 font-weight-medium text-uppercase"-->
              <!--                      style="font-size:12px; letter-spacing:1px; padding-top:2px">Italian</div> Milano Luiss Hub </span>-->
              <!--                  </div>-->
              <!--                  <div-->
              <!--                      class="col-lg-2 col-sm-6 mb-sm-0 mb-4 text-center border-left d-sm-block d-flex align-items-center">-->
      ...
      <!--          </div>-->
      <!--        </div>-->
      <!--&lt;!&ndash;        <div class="container block-text pb-5 mb-5" id="row-1">&ndash;&gt;-->
      <!--&lt;!&ndash;          <div class="row justify-content-between align-items-center">&ndash;&gt;-->
      <!--&lt;!&ndash;            <div class="col-md-5 order-md-2 pl-md-5"><h2 class="mb-3">A network of 500 companies</h2>&ndash;&gt;-->
      <!--&lt;!&ndash;              <p>With our Talent Acquisition program you will be able to get in touch with the companies of our network&ndash;&gt;-->
      <!--&lt;!&ndash;                having access to several career opportunities.</p>&ndash;&gt;-->
      <!--&lt;!&ndash;              <ul class="list-unstyled media-list">&ndash;&gt;-->
      <!--&lt;!&ndash;                <li class="media border-bottom py-2 align-items-center"><span&ndash;&gt;-->
      <!--&lt;!&ndash;                    class="mr-3 text-primary font-weight-bold  text-center">1</span>&ndash;&gt;-->
      <!--&lt;!&ndash;                  <div class="media-body"><p class="mb-0">Continuous updating of career opportunities</p></div>&ndash;&gt;-->
      <!--&lt;!&ndash;                </li>&ndash;&gt;-->
      <!--&lt;!&ndash;                <li class="media border-bottom py-2 align-items-center"><span&ndash;&gt;-->
      <!--&lt;!&ndash;                    class="mr-3 text-primary font-weight-bold  text-center">2</span>&ndash;&gt;-->
      <!--&lt;!&ndash;                  <div class="media-body"><p class="mb-0">Interview days with companies</p></div>&ndash;&gt;-->
      <!--&lt;!&ndash;                </li>&ndash;&gt;-->
      <!--&lt;!&ndash;                <li class="media border-bottom py-2 align-items-center"><span&ndash;&gt;-->
      <!--&lt;!&ndash;                    class="mr-3 text-primary font-weight-bold  text-center">3</span>&ndash;&gt;-->
      <!--&lt;!&ndash;                  <div class="media-body"><p class="mb-0">Personal Branding and CV Editing activities</p></div>&ndash;&gt;-->
      <!--&lt;!&ndash;                </li>&ndash;&gt;-->
      <!--&lt;!&ndash;              </ul>&ndash;&gt;-->
      <!--&lt;!&ndash;            </div>&ndash;&gt;-->
      <!--&lt;!&ndash;            <div class="col-md-7 order-md-1 mt-md-0 mt-5"><img class="w-100"&ndash;&gt;-->
      <!--&lt;!&ndash;                                                               src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2020/11/Talent_Garden_Zoom_Background_6-900x720.jpg"&ndash;&gt;-->
      <!--&lt;!&ndash;                                                               alt=""></div>&ndash;&gt;-->
      <!--&lt;!&ndash;          </div>&ndash;&gt;-->
      <!--&lt;!&ndash;        </div>&ndash;&gt;-->
      <!--        <div class="container block-text pb-5" id="row-2">-->
      <!--          <div class="row align-items-center">-->
      <!--            <div class="col-md-12"><h2 class="mb-5"></h2></div>-->
      <!--            <div class="col-md-12">-->
      ...
      <!--                    alt="" class="mx-auto"></li>-->
      <!--                <li class="col-lg-2 col-md-4 col-6 mb-md-5 text-center mb-md-0 mb-5"><img-->
      <!--                    src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2019/10/poste-italine.jpg"-->
      <!--                    alt="" class="mx-auto"></li>-->
      <!--                <li class="col-lg-2 col-md-4 col-6 mb-md-5 text-center mb-md-0 mb-5"><img-->
      ...
      <!--          </div>-->
      <!--        </div>-->
      <!--&lt;!&ndash;        <div class="bg-primary" id="manager">&ndash;&gt;-->
      <!--&lt;!&ndash;          <div class="container py-5" id="row-3">&ndash;&gt;-->
      <!--&lt;!&ndash;            <div class="row align-items-center">&ndash;&gt;-->
      <!--&lt;!&ndash;              <div class="col-md-6"><h2 class="white">Meet the team</h2>&ndash;&gt;-->
      <!--&lt;!&ndash;                <p><span style="font-weight: 400;">Graduated in Communication Sciences for institutions and companies at the University of Turin, Giulia Amico di Meane has gained decades of experience in FCA (Fiat Chrysler Automobiles), covering various managerial roles over the years. She began her career in FCA in Commercial Training, managing the launch of new products for all the brands in the group. Her experience continues as EMEA Product Marketing Manager for Fiat Panda, before becoming Fiat Brand’s Innovation &amp; Customer Experience Manager.</span>&ndash;&gt;-->
      <!--&lt;!&ndash;                </p></div>&ndash;&gt;-->
      <!--&lt;!&ndash;              <div class="col-md-5 ml-auto text-center profile">&ndash;&gt;-->
      <!--&lt;!&ndash;                <div class="avatar d-block mx-auto mb-3"><img class="align-self-center"&ndash;&gt;-->
      <!--&lt;!&ndash;                                                              src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2019/09/giulia-amico.jpg"&ndash;&gt;-->
      <!--&lt;!&ndash;                                                              alt=""></div>&ndash;&gt;-->
      <!--&lt;!&ndash;                <p class="white text-center d-block"><strong class="white lubalin font-size-18">Giulia Amico di&ndash;&gt;-->
      <!--&lt;!&ndash;                  Meane</strong><br> <em class="white">Innovation School Director</em></p></div>&ndash;&gt;-->
      <!--&lt;!&ndash;            </div>&ndash;&gt;-->
      <!--&lt;!&ndash;          </div>&ndash;&gt;-->
      <!--&lt;!&ndash;        </div>&ndash;&gt;-->
      <!--      </div>-->
      <!--      <div class="mappa bg-light">-->
      <!--        <div class="row align-items-center mx-0">-->
      <!--          <div class="col-lg-5 col-md-6 py-5 order-md-2 px-5"><h3 class="mb-3">Talent Garden<br> Innovation School<br>-->
      <!--            <span class="orange"></span></h3>-->
      <!--            <div class="d-block py-2 border-bottom mb-2"><span class="font-weight-bold black mb-0">Talent Garden Calabiana, Milano</span>-->
      <!--              <p class="mb-0">Via Arcivescovo Calabiana 6, 20100 Milan - Italy</p></div>-->
      <!--            <div class="d-block py-2 border-bottom mb-2"><span class="font-weight-bold black mb-0">Talent Garden Ostiense, Roma</span>-->
      <!--              <p class="mb-0">Via Ostiense 92, 00154 Roma RM - Italy</p></div>-->
      <!--            <div class="d-block py-2 border-bottom mb-2"><span class="font-weight-bold black mb-0">Talent Garden Isola, Milano</span>-->
      <!--              <p class="mb-0">Piazza Città di Lombardia 1, 20124 Milan - Italy</p></div>-->
      <!--            <div class="d-block py-2 border-bottom mb-2"><span class="font-weight-bold black mb-0">Talent Garden Fondazione Agnelli, Torino</span>-->
      <!--              <p class="mb-0">Via Giuseppe Giacosa 38, 10125 Turin - Italy</p></div>-->
      <!--          </div>-->
      <!--          <div class="col-lg-7 col-md-6 order-md-1 mt-md-0 mt-5 px-0 ">-->
      <!--            <div id="map-campus"-->
      <!--                 style="height: 600px; background: rgb(85, 85, 85); position: relative; overflow: hidden;"-->
      <!--                 class="w-100">-->
      <!--              <div-->
      ...
      <!--                          <div style="position: absolute; z-index: 995; transform: matrix(1, 0, 0, 1, -229, -172);">-->
      ...
      <!--                        </div>-->
      <!--                        <div-->
      <!--                            style="width: 33px; height: 44px; overflow: hidden; position: absolute; left: -37px; top: -99px; z-index: -55;">-->
      <!--                          <img alt=""-->
      <!--                               src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/themes/tag/assets/img/icon/pin.png"-->
      <!--                               draggable="false"-->
      <!--                               style="position: absolute; left: 0px; top: 0px; user-select: none; width: 33px; height: 44px; border: 0px; padding: 0px; margin: 0px; max-width: none; opacity: 1;">-->
      <!--                        </div>-->
      <!--                        <div-->
      <!--                            style="width: 33px; height: 44px; overflow: hidden; position: absolute; left: 38px; top: 13px; z-index: 57;">-->
      <!--                          <img alt=""-->
      <!--                               src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/themes/tag/assets/img/icon/pin.png"-->
      <!--                               draggable="false"-->
      <!--                               style="position: absolute; left: 0px; top: 0px; user-select: none; width: 33px; height: 44px; border: 0px; padding: 0px; margin: 0px; max-width: none; opacity: 1;">-->
      <!--                        </div>-->
      <!--                        <div-->
      <!--                            style="width: 33px; height: 44px; overflow: hidden; position: absolute; left: -37px; top: -101px; z-index: -57;">-->
      <!--                          <img alt=""-->
      <!--                               src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/themes/tag/assets/img/icon/pin.png"-->
      <!--                               draggable="false"-->
      <!--                               style="position: absolute; left: 0px; top: 0px; user-select: none; width: 33px; height: 44px; border: 0px; padding: 0px; margin: 0px; max-width: none; opacity: 1;">-->
      <!--                        </div>-->
      <!--                        <div-->
      <!--                            style="width: 33px; height: 44px; overflow: hidden; position: absolute; left: -71px; top: -87px; z-index: -43;">-->
      <!--                          <img alt=""-->
      <!--                               src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/themes/tag/assets/img/icon/pin.png"-->
      <!--                               draggable="false"-->
      <!--                               style="position: absolute; left: 0px; top: 0px; user-select: none; width: 33px; height: 44px; border: 0px; padding: 0px; margin: 0px; max-width: none; opacity: 1;">-->
      ...
      <!--                                 src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i5!2i17!3i11!4i256!2m3!1e0!2sm!3i566292796!3m17!2sen-US!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!!4e0&amp;key=AIzaSyD3qp2b1oSi_PIiA-ta0foe-RGzAzax5XM&amp;token=56349"-->
      <!--                                 style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">-->
      <!--                          </div>-->
      <!--                          <div-->
      <!--                              style="position: absolute; left: 0px; top: 0px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">-->
      <!--                            <img draggable="false" alt="" role="presentation"-->
      <!--                                 src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i5!2i16!3i11!4i256!2m3!1e0!2sm!3i566292796!3m17!2sen-US!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!!4e0&amp;key=AIzaSyD3qp2b1oSi_PIiA-ta0foe-RGzAzax5XM&amp;token=21243"-->
      <!--                                 style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">-->
      <!--                          </div>-->
      <!--                          <div-->
      <!--                              style="position: absolute; left: 0px; top: -256px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">-->
      <!--                            <img draggable="false" alt="" role="presentation"-->
      <!--                                 src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i5!2i16!3i10!4i256!2m3!1e0!2sm!3i566292796!3m17!2sen-US!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!!4e0&amp;key=AIzaSyD3qp2b1oSi_PIiA-ta0foe-RGzAzax5XM&amp;token=117497"-->
      <!--                                 style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">-->
      <!--                          </div>-->
      <!--                          <div-->
      <!--                              style="position: absolute; left: 256px; top: -256px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">-->
      <!--                            <img draggable="false" alt="" role="presentation"-->
      <!--                                 src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i5!2i17!3i10!4i256!2m3!1e0!2sm!3i566292796!3m17!2sen-US!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!!4e0&amp;key=AIzaSyD3qp2b1oSi_PIiA-ta0foe-RGzAzax5XM&amp;token=21532"-->
      <!--                                 style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">-->
      <!--                          </div>-->
      <!--                          <div-->
      <!--                              style="position: absolute; left: 512px; top: -256px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">-->
      <!--                            <img draggable="false" alt="" role="presentation"-->
      <!--                                 src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i5!2i18!3i10!4i256!2m3!1e0!2sm!3i566292796!3m17!2sen-US!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!!4e0&amp;key=AIzaSyD3qp2b1oSi_PIiA-ta0foe-RGzAzax5XM&amp;token=56638"-->
      <!--                                 style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">-->
      <!--                          </div>-->
      <!--                          <div-->
      <!--                              style="position: absolute; left: 512px; top: 0px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">-->
      <!--                            <img draggable="false" alt="" role="presentation"-->
      <!--                                 src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i5!2i18!3i11!4i256!2m3!1e0!2sm!3i566292796!3m17!2sen-US!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!!4e0&amp;key=AIzaSyD3qp2b1oSi_PIiA-ta0foe-RGzAzax5XM&amp;token=91455"-->
      <!--                                 style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">-->
      <!--                          </div>-->
      <!--                          <div-->
      <!--                              style="position: absolute; left: -256px; top: 0px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">-->
      <!--                            <img draggable="false" alt="" role="presentation"-->
      <!--                                 src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i5!2i15!3i11!4i256!2m3!1e0!2sm!3i566292796!3m17!2sen-US!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!!4e0&amp;key=AIzaSyD3qp2b1oSi_PIiA-ta0foe-RGzAzax5XM&amp;token=117208"-->
      <!--                                 style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">-->
      <!--                          </div>-->
      <!--                          <div-->
      <!--                              style="position: absolute; left: -256px; top: -256px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">-->
      <!--                            <img draggable="false" alt="" role="presentation"-->
      <!--                                 src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i5!2i15!3i10!4i256!2m3!1e0!2sm!3i566292796!3m17!2sen-US!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!!4e0&amp;key=AIzaSyD3qp2b1oSi_PIiA-ta0foe-RGzAzax5XM&amp;token=82391"-->
      <!--                                 style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">-->
      <!--                          </div>-->
      <!--                          <div-->
      <!--                              style="position: absolute; left: 512px; top: 256px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">-->
      <!--                            <img draggable="false" alt="" role="presentation"-->
      <!--                                 src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i5!2i18!3i12!4i256!2m3!1e0!2sm!3i566292796!3m17!2sen-US!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!!4e0&amp;key=AIzaSyD3qp2b1oSi_PIiA-ta0foe-RGzAzax5XM&amp;token=126272"-->
      <!--                                 style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">-->
      <!--                          </div>-->
      <!--                          <div-->
      <!--                              style="position: absolute; left: 0px; top: 256px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">-->
      <!--                            <img draggable="false" alt="" role="presentation"-->
      <!--                                 src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i5!2i16!3i12!4i256!2m3!1e0!2sm!3i566292796!3m17!2sen-US!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!!4e0&amp;key=AIzaSyD3qp2b1oSi_PIiA-ta0foe-RGzAzax5XM&amp;token=56060"-->
      <!--                                 style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">-->
      <!--                          </div>-->
      <!--                          <div-->
      <!--                              style="position: absolute; left: -256px; top: 256px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">-->
      <!--                            <img draggable="false" alt="" role="presentation"-->
      <!--                                 src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i5!2i15!3i12!4i256!2m3!1e0!2sm!3i566292760!3m17!2sen-US!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!!4e0&amp;key=AIzaSyD3qp2b1oSi_PIiA-ta0foe-RGzAzax5XM&amp;token=99230"-->
      <!--                                 style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">-->
      <!--                          </div>-->
      <!--                          <div-->
      <!--                              style="position: absolute; left: 256px; top: 256px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">-->
      <!--                            <img draggable="false" alt="" role="presentation"-->
      <!--                                 src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i5!2i17!3i12!4i256!2m3!1e0!2sm!3i566292796!3m17!2sen-US!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!!4e0&amp;key=AIzaSyD3qp2b1oSi_PIiA-ta0foe-RGzAzax5XM&amp;token=91166"-->
      <!--                                 style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">-->
      <!--                          </div>-->
      <!--                        </div>-->
      <!--                      </div>-->
      ...
      <!--                               style="width: 33px; height: 44px; overflow: hidden; position: absolute; cursor: pointer; touch-action: none; left: -37px; top: -99px; z-index: -55;">-->
      ...
      <!--                               style="width: 33px; height: 44px; overflow: hidden; position: absolute; cursor: pointer; touch-action: none; left: 38px; top: 13px; z-index: 57;">-->
      <!--                            <img alt="" src="https://maps.gstatic.com/mapfiles/transparent.png" draggable="false"-->
      <!--                                 style="width: 33px; height: 44px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">-->
      <!--                          </div>-->
      <!--                          <div title="" role="button" tabindex="-1"-->
      <!--                               style="width: 33px; height: 44px; overflow: hidden; position: absolute; cursor: pointer; touch-action: none; left: -37px; top: -101px; z-index: -57;">-->
      <!--                            <img alt="" src="https://maps.gstatic.com/mapfiles/transparent.png" draggable="false"-->
      <!--                                 style="width: 33px; height: 44px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">-->
      <!--                          </div>-->
      <!--                          <div title="" role="button" tabindex="-1"-->
      <!--                               style="width: 33px; height: 44px; overflow: hidden; position: absolute; cursor: pointer; touch-action: none; left: -71px; top: -87px; z-index: -43;">-->
      <!--                            <img alt="" src="https://maps.gstatic.com/mapfiles/transparent.png" draggable="false"-->
      <!--                                 style="width: 33px; height: 44px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">-->
      <!--                          </div>-->
      <!--                        </div>-->
      ...
      <!--                                aria-pressed="true" id="58981DB6-E269-4753-80EC-D7D36D9D9558" aria-expanded="false"-->
      ...
      <!--                          Map-->
      <!--                        </button>-->
      <!--                        <ul role="menu" aria-labelledby="58981DB6-E269-4753-80EC-D7D36D9D9558"-->
      ...
      <!--                                type="button" aria-pressed="false" id="1818AE0F-35BD-4517-9A9B-E4BE94054441"-->
      <!--                                aria-expanded="false"-->
      ...
      <!--                          Satellite-->
      <!--                        </button>-->
      <!--                        <ul role="menu" aria-labelledby="1818AE0F-35BD-4517-9A9B-E4BE94054441"-->
      ...
      <!--                         href="https://maps.google.com/maps?ll=43.704471,10.078844&amp;z=5&amp;t=m&amp;hl=en-US&amp;gl=US&amp;mapclient=apiv3"-->
      ...
      <!--                           dir="ltr"-->
      <!--                           href="https://www.google.com/maps/@43.7044709,10.0788437,5z/data=!10m1!1e1!12b1?source=apiv3&amp;rapsrc=apiv3"-->
...
export default {
  ...
  data() {
    return {
      courses: [
        {name: 'PHP and PHP MVC Frameworks Laravel/Codeigniter'},
        {name: 'Javascript-Angular Js, Nodejs'},
        {name: 'AWS and Cloud Infrastructure'},
        {name: 'Data Science'},
        {name: 'Startup 101-Business plan, marketing, finance'},
        {name: 'DeFI and Crypto'},
        {name: 'Introduction to Programming-13-18yrs'},
      ]
    }
  }
}
