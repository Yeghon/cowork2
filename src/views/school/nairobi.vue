        ...
        <div class="row py-5">
          <div class="col-lg-5 order-lg-2 pt-4">
            <div class="max-text mx-auto">
              ...
              <div class="line"></div>
              <h1 class="mt-2">Talent Garden Innovation School <span class="orange">Italy</span></h1>
              <p>Talent Garden Innovation School is an innovative educational institute that<br> uses a disruptive
                learning approach that puts people at the centre through<br> a cutting-edge training methodology. We
                deliver in-depth courses and training<br> programs for both individuals and companies, focusing on five
                key areas coding,<br> data, marketing, design and business. We offer Bootcamps, Digital
                Transformation<br> Programs and Masterclasses in digital technologies and innovation fields.</p> <a
      ...
      <div class="pt-5 mt-5">
        ...
        <div class="container block-text pb-5 mb-5" id="row-1">
          <div class="row justify-content-between align-items-center">
            ...
            <div class="col-md-7 order-md-1 mt-md-0 mt-5"><img class="w-100"
                                                               src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2020/11/Talent_Garden_Zoom_Background_6-900x720.jpg"
                                                               alt=""></div>
          </div>
        </div>
        ...
        <div class="bg-primary" id="manager">
          <div class="container py-5" id="row-3">
            <div class="row align-items-center">
              <div class="col-md-6"><h2 class="white">Meet the team</h2>
              ...
              <div class="col-md-5 ml-auto text-center profile">
                ...
                <p class="white text-center d-block"><strong class="white lubalin font-size-18">Giulia Amico di
                  Meane</strong><br> <em class="white">Innovation School Director</em></p></div>
            </div>
          </div>
        </div>
      </div>
