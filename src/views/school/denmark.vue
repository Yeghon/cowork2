      ...
      <div class="container-medium pt-5 pb-5 page-intro">
        <div class="row py-5">
          <div class="col-lg-5 order-lg-2 pt-4">
            <div class="max-text mx-auto">
              <nav aria-label="breadcrumb" class="breadcrumb_nav mb-3" typeof="BreadcrumbList"
                  ...
                  property="name">Denmark</span><meta property="position" content="3"></span></nav>
              <div class="line"></div>
              <h1 class="mt-2">Talent Garden Innovation School <span class="orange">Denmark</span></h1>
              <p>Talent Garden Innovation School Copenhagen is an innovative educational institute that uses a
                disruptive learning approach that puts people at the centre through a cutting-edge training methodology.
                We deliver in-depth courses and training programs for both individuals and companies, focusing on five
                key areas: coding, data, marketing, design and business. We offer Bootcamps, Digital Transformation
                Programs and Masterclasses in digital technologies and innovation fields. Located at Talent Garden
                Rainmaking, the award-winning workspace in the heart of Copenhagen.</p> <a href="#course"
          ...
          <div class="col-lg-7 mt-lg-0 mt-5 order-lg-1 pr-lg-5"><img class="w-100 d-block"
                                                                     src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2019/11/Learning-Space-900x720.png"
                                                                     alt=""></div>
        </div>
      </div>
          ...
          <div class="col-12">
            ...
            <form class="controls row my-5 align-items-center">
              ...
              <fieldset class="col-md-3 col-sm-6 my-sm-0 my-3 select-wrapper" data-filter-group=""><span
                ...
                <option value=".unemployment-training">Unemployment Training</option>
              </select></fieldset>
            ...
            <div class="mt-5 container-filter" id="MixItUpC3D454">
                ...
                <div class="row align-items-center py-1">
                  <div class="col-lg-7 mb-lg-0 mb-4 pb-lg-0 pb-4">
                    <div class="type d-inline-block mr-2 font-weight-bold text-uppercase text-primary"
                         style="font-size:12px; letter-spacing:2px">Denmark
                    </div>
                    <h4 class="black lubalin font-weight-bold mb-0 font-size-24 d-block my-2">Project Management
                      Course</h4> <span class="black"><div
                      class="lang d-inline-block px-2 border mr-2 font-weight-medium text-uppercase"
                      style="font-size:12px; letter-spacing:1px; padding-top:2px">English</div> Copenhagen </span></div>
                  <div
                      class="col-lg-2 col-sm-6 mb-sm-0 mb-4 text-center border-left d-sm-block d-flex align-items-center">
                    <span class="primary d-block mb-0">20.09.2021</span> <span
                      class="black lett-space-2 font-size-12 text-uppercase ml-auto">Unemployment Training</span></div>
              ...
              <div class="mix  denmark  unemployment-training  rainmaking-copenhagen  english  design"><a
                ...
                <div class="row align-items-center py-1">
                  <div class="col-lg-7 mb-lg-0 mb-4 pb-lg-0 pb-4">
                    ...
                    <h4 class="black lubalin font-weight-bold mb-0 font-size-24 d-block my-2">UX and Graphic Design
                      Course (Brugervenlighed og Grafisk Design)</h4> <span class="black"><div
                      class="lang d-inline-block px-2 border mr-2 font-weight-medium text-uppercase"
                      style="font-size:12px; letter-spacing:1px; padding-top:2px">English</div> Copenhagen </span></div>
                  <div
                      class="col-lg-2 col-sm-6 mb-sm-0 mb-4 text-center border-left d-sm-block d-flex align-items-center">
                    <span class="primary d-block mb-0">21.09.2021</span> <span
                      class="black lett-space-2 font-size-12 text-uppercase ml-auto">Unemployment Training</span></div>
                  <div class="col-lg-3 col-sm-6"><span class="btn btn-primary d-block py-3">Learn more</span></div>
                </div>
              </a></div>
              <div class="mix  denmark  unemployment-training  rainmaking-copenhagen  english  marketing"><a
                ...
                <div class="row align-items-center py-1">
                  ...
                  <div
                      class="col-lg-2 col-sm-6 mb-sm-0 mb-4 text-center border-left d-sm-block d-flex align-items-center">
                    <span class="primary d-block mb-0">05.10.2021</span> <span
                      class="black lett-space-2 font-size-12 text-uppercase ml-auto">Unemployment Training</span></div>
                  <div class="col-lg-3 col-sm-6"><span class="btn btn-primary d-block py-3">Learn more</span></div>
                </div>
              </a></div>
        ...
        <div class="container block-text pb-5 mb-5" id="row-1">
          <div class="row justify-content-between align-items-center">
            ...
            <div class="col-md-7 order-md-1 mt-md-0 mt-5"><img class="w-100"
                                                               src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2019/10/05-talent-garden-Rainmaking-Copenhagen-coworking-space.jpg"
                                                               alt=""></div>
          </div>
        </div>
        <div class="bg-primary" id="manager">
          <div class="container py-5" id="row-2">
            <div class="row align-items-center">
              <div class="col-md-6"><h2 class="white">Meet our team</h2></div>
              <div class="col-md-5 ml-auto text-center profile">
                <div class="avatar d-block mx-auto mb-3"><img class="align-self-center"
                                                              src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2019/11/Anna-cappi.jpg"
                                                              alt="Anna_Cappi"></div>
                <p class="white text-center d-block"><strong class="white lubalin font-size-18">Anna Cappi</strong><br>
                  <em class="white">Head of Learning at Talent Garden Innovation School</em></p></div>
            </div>
          </div>
        </div>
      </div>
      <div class="mappa bg-light">
        <div class="row align-items-center mx-0">
          <div class="col-lg-5 col-md-6 py-5 order-md-2 px-5"><h3 class="mb-3">Talent Garden<br> Innovation School<br>
            ...
            <div class="d-block py-2 border-bottom mb-2"><span class="font-weight-bold black mb-0">Talent Garden Rainmaking, Copenhagen</span>
              <p class="mb-0">Danneskiold-Samsøes Allé 41, 1434 Copenhagen - Danmark</p></div>
          </div>
                    ...
                    <div
                      ...
                      <div style="position: absolute; left: 0px; top: 0px; z-index: 100; width: 100%;">
                        <div style="position: absolute; left: 0px; top: 0px; z-index: 0;">
                          <div style="position: absolute; z-index: 995; transform: matrix(1, 0, 0, 1, -31, -4);">
                      ...
                      <div style="position: absolute; left: 0px; top: 0px; z-index: 0;">
                        <div style="position: absolute; z-index: 995; transform: matrix(1, 0, 0, 1, -31, -4);">
                          ...
                          <div
                            ...
                            <img draggable="false" alt="" role="presentation"
                                 src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i5!2i15!3i8!4i256!2m3!1e0!2sm!3i566292748!3m17!2sen-US!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!!4e0&amp;key=AIzaSyD3qp2b1oSi_PIiA-ta0foe-RGzAzax5XM&amp;token=52332"
                                 style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                          </div>
                          <div
                              style="position: absolute; left: -256px; top: -512px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                            <img draggable="false" alt="" role="presentation"
                                 src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i5!2i16!3i8!4i256!2m3!1e0!2sm!3i566292712!3m17!2sen-US!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!!4e0&amp;key=AIzaSyD3qp2b1oSi_PIiA-ta0foe-RGzAzax5XM&amp;token=8730"
                                 style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                          </div>
                          <div
                              style="position: absolute; left: 0px; top: -512px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                            <img draggable="false" alt="" role="presentation"
                                 src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i5!2i17!3i8!4i256!2m3!1e0!2sm!3i566292748!3m17!2sen-US!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!!4e0&amp;key=AIzaSyD3qp2b1oSi_PIiA-ta0foe-RGzAzax5XM&amp;token=70718"
                                 style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                          </div>
                          <div
                              style="position: absolute; left: 256px; top: -512px; width: 256px; height: 256px; transition: opacity 200ms linear 0s;">
                            <img draggable="false" alt="" role="presentation"
                                 src="https://maps.googleapis.com/maps/vt?pb=!1m5!1m4!1i5!2i18!3i8!4i256!2m3!1e0!2sm!3i566292748!3m17!2sen-US!3sUS!5e18!12m4!1e68!2m2!1sset!2sRoadmap!12m3!1e37!2m1!1ssmartmaps!12m4!1e26!2m2!1sstyles!!4e0&amp;key=AIzaSyD3qp2b1oSi_PIiA-ta0foe-RGzAzax5XM&amp;token=79911"
                                 style="width: 256px; height: 256px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="gmnoprint"
                      ...
                      <div class="gm-style-mtc" style="float: left; position: relative;">
                        <button draggable="false" aria-label="Show street map" title="Show street map" type="button"
                                aria-pressed="true" id="799ECAF8-7C78-4A84-9F5E-24A2A4379DDC" aria-expanded="false"
                        ...
                        <ul role="menu" aria-labelledby="799ECAF8-7C78-4A84-9F5E-24A2A4379DDC"
                      ...
                      <div class="gm-style-mtc" style="float: left; position: relative;">
                        <button draggable="false" aria-label="Show satellite imagery" title="Show satellite imagery"
                                type="button" aria-pressed="false" id="A7B559D3-62B2-444D-A980-FAB8DF108581"
                                aria-expanded="false"
                        ...
                        <ul role="menu" aria-labelledby="A7B559D3-62B2-444D-A980-FAB8DF108581"
                  ...
                  <div>
                    <div
                      ...
                      <a target="_blank" rel="noopener"
                         href="https://maps.google.com/maps?ll=55.680561,12.601501&amp;z=5&amp;t=m&amp;hl=en-US&amp;gl=US&amp;mapclient=apiv3"
                    ...
                    <div draggable="false" class="gm-style-cc"
                      ...
                      <div
                        ...
                        <a target="_blank" rel="noopener" title="Report errors in the road map or imagery to Google"
                           dir="ltr"
                           href="https://www.google.com/maps/@55.6805607,12.6015008,5z/data=!10m1!1e1!12b1?source=apiv3&amp;rapsrc=apiv3"
