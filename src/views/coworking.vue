  ...
  <div>
    ...
    <main>
      ...
      <div class="wrapper-flex">
        <div class="py-5" id="row-0">
          <div class="container">
            <div class="row align-items-center">
              <div class="col-12 mb-4 pt-5"><h2 class="mb-3">Campus Amenities</h2>
                <p></p></div>
            </div>
          </div>
          <div class="container pb-5">
            <div class="row align-items-stretch">
              <div class="col-lg-3 col-md-4 col-6 mb-4">
                <div class="bg-light px-3 py-5 text-center h-100 d-flex flex-column"><img
                    src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2021/03/outline_location_on_black_18dp.png"
                    class="mx-auto d-inline-block" style="max-height: 60px">
                  <p class="font-weight-bold black mt-3 mb-0" style="font-size: 18px">24/7 Access</p></div>
              </div>
              <div class="col-lg-3 col-md-4 col-6 mb-4">
                <div class="bg-light px-3 py-5 text-center h-100 d-flex flex-column"><img
                    src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2021/03/outline_clean_hands_black_18dp.png"
                    class="mx-auto d-inline-block" style="max-height: 60px">
                  <p class="font-weight-bold black mt-3 mb-0" style="font-size: 18px">Enhanced Cleaning</p></div>
              </div>
              <div class="col-lg-3 col-md-4 col-6 mb-4">
                <div class="bg-light px-3 py-5 text-center h-100 d-flex flex-column"><img
                    src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2021/03/outline_meeting_room_black_18dp.png"
                    class="mx-auto d-inline-block" style="max-height: 60px">
                  <p class="font-weight-bold black mt-3 mb-0" style="font-size: 18px">Meeting Rooms</p></div>
              </div>
              <div class="col-lg-3 col-md-4 col-6 mb-4">
                <div class="bg-light px-3 py-5 text-center h-100 d-flex flex-column"><img
                    src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2021/03/outline_groups_black_18dp.png"
                    class="mx-auto d-inline-block" style="max-height: 60px">
                  <p class="font-weight-bold black mt-3 mb-0" style="font-size: 18px">Community Activities</p></div>
              </div>
              <div class="col-lg-3 col-md-4 col-6 mb-4">
                <div class="bg-light px-3 py-5 text-center h-100 d-flex flex-column"><img
                    src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2021/03/outline_wifi_black_18dp.png"
                    class="mx-auto d-inline-block" style="max-height: 60px">
                  <p class="font-weight-bold black mt-3 mb-0" style="font-size: 18px">High-speed WiFi</p></div>
              </div>
              <div class="col-lg-3 col-md-4 col-6 mb-4">
                <div class="bg-light px-3 py-5 text-center h-100 d-flex flex-column"><img
                    src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2021/03/outline_school_black_18dp.png"
                    class="mx-auto d-inline-block" style="max-height: 60px">
                  <p class="font-weight-bold black mt-3 mb-0" style="font-size: 18px">Free Workshops<br> and Events</p>
                </div>
              </div>
              <div class="col-lg-3 col-md-4 col-6 mb-4">
                <div class="bg-light px-3 py-5 text-center h-100 d-flex flex-column"><img
                    src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2021/03/outline_contact_support_black_18dp.png"
                    class="mx-auto d-inline-block" style="max-height: 60px">
                  <p class="font-weight-bold black mt-3 mb-0" style="font-size: 18px">On-site Staff</p></div>
              </div>
              <div class="col-lg-3 col-md-4 col-6 mb-4">
                <div class="bg-light px-3 py-5 text-center h-100 d-flex flex-column"><img
                    src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2021/03/outline_markunread_mailbox_black_18dp.png"
                    class="mx-auto d-inline-block" style="max-height: 60px">
                  <p class="font-weight-bold black mt-3 mb-0" style="font-size: 18px">Printing, Scanning <br> and Mail
                    Services</p></div>
              </div>
            </div>
          </div>
        </div>
        <div class="container block-text pb-5" id="row-1">
          <div class="row align-items-center">
            <div class="col-md-12"><h2 class="mb-5">Our Community</h2></div>
            <div class="col-md-12">
              <ul class="list-unstyled row logos justify-content-start">
                ...
                <li class="col-lg-2 col-md-4 col-6 mb-md-5 text-center mb-md-0 mb-5"><img
                    ...
                    alt="Blablacar logo" class="mx-auto"></li>
                <li class="col-lg-2 col-md-4 col-6 mb-md-5 text-center mb-md-0 mb-5"><img
                    src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2019/10/deliveroo.jpg"
                    alt="" class="mx-auto"></li>
                <li class="col-lg-2 col-md-4 col-6 mb-md-5 text-center mb-md-0 mb-5"><img
                    src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2019/10/1.png"
                    alt="Bosch logo" class="mx-auto"></li>
                <li class="col-lg-2 col-md-4 col-6 mb-md-5 text-center mb-md-0 mb-5"><img
                ...
                <li class="col-lg-2 col-md-4 col-6 mb-md-5 text-center mb-md-0 mb-5"><img
                    ...
                    alt="" class="mx-auto"></li>
                <li class="col-lg-2 col-md-4 col-6 mb-md-5 text-center mb-md-0 mb-5"><img
                    src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2021/03/Business-Insiders-logo.png"
                    alt="" class="mx-auto"></li>
                <li class="col-lg-2 col-md-4 col-6 mb-md-5 text-center mb-md-0 mb-5"><img
                    src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2021/03/Robotify-new-logos.png"
                    alt="" class="mx-auto"></li>
                <li class="col-lg-2 col-md-4 col-6 mb-md-5 text-center mb-md-0 mb-5"><img
                    src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2021/03/Endotronix-logo.png"
                    alt="" class="mx-auto"></li>
                <li class="col-lg-2 col-md-4 col-6 mb-md-5 text-center mb-md-0 mb-5"><img
                    src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2021/03/Wallbox-logo.png"
                    alt="" class="mx-auto"></li>
                <li class="col-lg-2 col-md-4 col-6 mb-md-5 text-center mb-md-0 mb-5"><img
                    src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2019/10/17.png"
                    alt="Urban Sports Club logo" class="mx-auto"></li>
                <li class="col-lg-2 col-md-4 col-6 mb-md-5 text-center mb-md-0 mb-5"><img
                    src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2021/03/Danish-Endurance-logo.png"
                    alt="" class="mx-auto"></li>
                <li class="col-lg-2 col-md-4 col-6 mb-md-5 text-center mb-md-0 mb-5"><img
                    src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2021/03/We-are-developers-logo-2.png"
                    alt="" class="mx-auto"></li>
                <li class="col-lg-2 col-md-4 col-6 mb-md-5 text-center mb-md-0 mb-5"><img
                    src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2021/03/Female-Factor-logo.png"
                    alt="" class="mx-auto"></li>
                <li class="col-lg-2 col-md-4 col-6 mb-md-5 text-center mb-md-0 mb-5"><img
                    src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2019/10/16.png"
                    alt="Uber logo" class="mx-auto"></li>
                <li class="col-lg-2 col-md-4 col-6 mb-md-5 text-center mb-md-0 mb-5"><img
                    src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2021/03/Live-healthcare-logo.png"
                    alt="" class="mx-auto"></li>
                <li class="col-lg-2 col-md-4 col-6 mb-md-5 text-center mb-md-0 mb-5"><img
                    src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2021/03/Mind-the-bridge-logo.png"
                    alt="" class="mx-auto"></li>
                <li class="col-lg-2 col-md-4 col-6 mb-md-5 text-center mb-md-0 mb-5"><img
                    src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2021/03/Viridian-software-logo.png"
                    alt="" class="mx-auto"></li>
              </ul>
            </div>
          </div>
                      ...
                      <div
                        ...
                        <div style="position: absolute; left: 0px; top: 0px; z-index: 100; width: 100%;">
                          <div style="position: absolute; left: 0px; top: 0px; z-index: 0;">
                            <div style="position: absolute; z-index: 995; transform: matrix(1, 0, 0, 1, -226, -25);">
                        ...
                        <div style="position: absolute; left: 0px; top: 0px; z-index: 103; width: 100%;">
                          ...
                          <div
                              style="width: 33px; height: 44px; overflow: hidden; position: absolute; left: 129px; top: -45px; z-index: -1;">
                            <img alt=""
                          ...
                          <div
                              style="width: 33px; height: 44px; overflow: hidden; position: absolute; left: 39px; top: -323px; z-index: -279;">
                            <img alt=""
                                 src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/themes/tag/assets/img/icon/pin.png"
                                 draggable="false"
                                 style="position: absolute; left: 0px; top: 0px; user-select: none; width: 33px; height: 44px; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                          ...
                          <div
                              style="width: 33px; height: 44px; overflow: hidden; position: absolute; left: 44px; top: -321px; z-index: -277;">
                            <img alt=""
                                 src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/themes/tag/assets/img/icon/pin.png"
                                 draggable="false"
                                 style="position: absolute; left: 0px; top: 0px; user-select: none; width: 33px; height: 44px; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                          ...
                          <div
                              style="width: 33px; height: 44px; overflow: hidden; position: absolute; left: -386px; top: -231px; z-index: -187;">
                            <img alt=""
                                 src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/themes/tag/assets/img/icon/pin.png"
                                 draggable="false"
                                 style="position: absolute; left: 0px; top: 0px; user-select: none; width: 33px; height: 44px; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                          ...
                          <div
                              style="width: 33px; height: 44px; overflow: hidden; position: absolute; left: -11px; top: 45px; z-index: 89;">
                            <img alt=""
                                 src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/themes/tag/assets/img/icon/pin.png"
                                 draggable="false"
                                 style="position: absolute; left: 0px; top: 0px; user-select: none; width: 33px; height: 44px; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                          ...
                          <div
                              style="width: 33px; height: 44px; overflow: hidden; position: absolute; left: -68px; top: 60px; z-index: 104;">
                            <img alt=""
                                 src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/themes/tag/assets/img/icon/pin.png"
                                 draggable="false"
                                 style="position: absolute; left: 0px; top: 0px; user-select: none; width: 33px; height: 44px; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                          ...
                          <div
                              style="width: 33px; height: 44px; overflow: hidden; position: absolute; left: -34px; top: 48px; z-index: 92;">
                            <img alt=""
                                 src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/themes/tag/assets/img/icon/pin.png"
                                 draggable="false"
                                 style="position: absolute; left: 0px; top: 0px; user-select: none; width: 33px; height: 44px; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                          ...
                          <div
                              style="width: 33px; height: 44px; overflow: hidden; position: absolute; left: 43px; top: 160px; z-index: 204;">
                            <img alt=""
                                 src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/themes/tag/assets/img/icon/pin.png"
                                 draggable="false"
                                 style="position: absolute; left: 0px; top: 0px; user-select: none; width: 33px; height: 44px; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                          ...
                          <div
                              style="width: 33px; height: 44px; overflow: hidden; position: absolute; left: 126px; top: 235px; z-index: 279;">
                            <img alt=""
                                 src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/themes/tag/assets/img/icon/pin.png"
                                 draggable="false"
                                 style="position: absolute; left: 0px; top: 0px; user-select: none; width: 33px; height: 44px; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                          ...
                          <div
                              style="width: 33px; height: 44px; overflow: hidden; position: absolute; left: -41px; top: 80px; z-index: 124;">
                            <img alt=""
                                 src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/themes/tag/assets/img/icon/pin.png"
                                 draggable="false"
                                 style="position: absolute; left: 0px; top: 0px; user-select: none; width: 33px; height: 44px; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                          ...
                          <div
                              style="width: 33px; height: 44px; overflow: hidden; position: absolute; left: -34px; top: 46px; z-index: 90;">
                            <img alt=""
                                 src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/themes/tag/assets/img/icon/pin.png"
                                 draggable="false"
                                 style="position: absolute; left: 0px; top: 0px; user-select: none; width: 33px; height: 44px; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                          ...
                          <div
                              style="width: 33px; height: 44px; overflow: hidden; position: absolute; left: 41px; top: 160px; z-index: 204;">
                            <img alt=""
                                 src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/themes/tag/assets/img/icon/pin.png"
                                 draggable="false"
                                 style="position: absolute; left: 0px; top: 0px; user-select: none; width: 33px; height: 44px; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                          ...
                          <div
                              style="width: 33px; height: 44px; overflow: hidden; position: absolute; left: 351px; top: 80px; z-index: 124;">
                            <img alt=""
                                 src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/themes/tag/assets/img/icon/pin.png"
                                 draggable="false"
                                 style="position: absolute; left: 0px; top: 0px; user-select: none; width: 33px; height: 44px; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                          ...
                          <div
                              style="width: 33px; height: 44px; overflow: hidden; position: absolute; left: -193px; top: 174px; z-index: 218;">
                            <img alt=""
                                 src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/themes/tag/assets/img/icon/pin.png"
                                 draggable="false"
                                 style="position: absolute; left: 0px; top: 0px; user-select: none; width: 33px; height: 44px; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                          ...
                          <div
                              style="width: 33px; height: 44px; overflow: hidden; position: absolute; left: -327px; top: 204px; z-index: 248;">
                            <img alt=""
                                 src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/themes/tag/assets/img/icon/pin.png"
                                 draggable="false"
                                 style="position: absolute; left: 0px; top: 0px; user-select: none; width: 33px; height: 44px; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                          ...
                          <div
                              style="width: 33px; height: 44px; overflow: hidden; position: absolute; left: 332px; top: -281px; z-index: -237;">
                            <img alt=""
                                 src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/themes/tag/assets/img/icon/pin.png"
                                 draggable="false"
                                 style="position: absolute; left: 0px; top: 0px; user-select: none; width: 33px; height: 44px; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                        ...
                        <div
                          ...
                          <div style="position: absolute; left: 0px; top: 0px; z-index: 106; width: 100%;">
                            <div title="" role="button" tabindex="0"
                                 style="width: 33px; height: 44px; overflow: hidden; position: absolute; cursor: pointer; touch-action: none; left: 129px; top: -45px; z-index: -1;">
                            ...
                            <div title="" role="button" tabindex="-1"
                                 style="width: 33px; height: 44px; overflow: hidden; position: absolute; cursor: pointer; touch-action: none; left: 39px; top: -323px; z-index: -279;">
                              <img alt="" src="https://maps.gstatic.com/mapfiles/transparent.png" draggable="false"
                                   style="width: 33px; height: 44px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                            </div>
                            <div title="" role="button" tabindex="-1"
                                 style="width: 33px; height: 44px; overflow: hidden; position: absolute; cursor: pointer; touch-action: none; left: 44px; top: -321px; z-index: -277;">
                              <img alt="" src="https://maps.gstatic.com/mapfiles/transparent.png" draggable="false"
                                   style="width: 33px; height: 44px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                            </div>
                            <div title="" role="button" tabindex="-1"
                                 style="width: 33px; height: 44px; overflow: hidden; position: absolute; cursor: pointer; touch-action: none; left: -386px; top: -231px; z-index: -187;">
                              <img alt="" src="https://maps.gstatic.com/mapfiles/transparent.png" draggable="false"
                                   style="width: 33px; height: 44px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                            </div>
                            <div title="" role="button" tabindex="-1"
                                 style="width: 33px; height: 44px; overflow: hidden; position: absolute; cursor: pointer; touch-action: none; left: -11px; top: 45px; z-index: 89;">
                              <img alt="" src="https://maps.gstatic.com/mapfiles/transparent.png" draggable="false"
                                   style="width: 33px; height: 44px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                            </div>
                            <div title="" role="button" tabindex="-1"
                                 style="width: 33px; height: 44px; overflow: hidden; position: absolute; cursor: pointer; touch-action: none; left: -68px; top: 60px; z-index: 104;">
                              <img alt="" src="https://maps.gstatic.com/mapfiles/transparent.png" draggable="false"
                                   style="width: 33px; height: 44px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                            </div>
                            <div title="" role="button" tabindex="-1"
                                 style="width: 33px; height: 44px; overflow: hidden; position: absolute; cursor: pointer; touch-action: none; left: -34px; top: 48px; z-index: 92;">
                              <img alt="" src="https://maps.gstatic.com/mapfiles/transparent.png" draggable="false"
                                   style="width: 33px; height: 44px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                            </div>
                            <div title="" role="button" tabindex="-1"
                                 style="width: 33px; height: 44px; overflow: hidden; position: absolute; cursor: pointer; touch-action: none; left: 43px; top: 160px; z-index: 204;">
                              <img alt="" src="https://maps.gstatic.com/mapfiles/transparent.png" draggable="false"
                                   style="width: 33px; height: 44px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                            </div>
                            <div title="" role="button" tabindex="-1"
                                 style="width: 33px; height: 44px; overflow: hidden; position: absolute; cursor: pointer; touch-action: none; left: 126px; top: 235px; z-index: 279;">
                              <img alt="" src="https://maps.gstatic.com/mapfiles/transparent.png" draggable="false"
                                   style="width: 33px; height: 44px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                            </div>
                            <div title="" role="button" tabindex="-1"
                                 style="width: 33px; height: 44px; overflow: hidden; position: absolute; cursor: pointer; touch-action: none; left: -41px; top: 80px; z-index: 124;">
                              <img alt="" src="https://maps.gstatic.com/mapfiles/transparent.png" draggable="false"
                                   style="width: 33px; height: 44px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                            </div>
                            <div title="" role="button" tabindex="-1"
                                 style="width: 33px; height: 44px; overflow: hidden; position: absolute; cursor: pointer; touch-action: none; left: -34px; top: 46px; z-index: 90;">
                              <img alt="" src="https://maps.gstatic.com/mapfiles/transparent.png" draggable="false"
                                   style="width: 33px; height: 44px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                            </div>
                            <div title="" role="button" tabindex="-1"
                                 style="width: 33px; height: 44px; overflow: hidden; position: absolute; cursor: pointer; touch-action: none; left: 41px; top: 160px; z-index: 204;">
                              <img alt="" src="https://maps.gstatic.com/mapfiles/transparent.png" draggable="false"
                                   style="width: 33px; height: 44px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                            </div>
                            <div title="" role="button" tabindex="-1"
                                 style="width: 33px; height: 44px; overflow: hidden; position: absolute; cursor: pointer; touch-action: none; left: 351px; top: 80px; z-index: 124;">
                              <img alt="" src="https://maps.gstatic.com/mapfiles/transparent.png" draggable="false"
                                   style="width: 33px; height: 44px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                            </div>
                            <div title="" role="button" tabindex="-1"
                                 style="width: 33px; height: 44px; overflow: hidden; position: absolute; cursor: pointer; touch-action: none; left: -193px; top: 174px; z-index: 218;">
                              <img alt="" src="https://maps.gstatic.com/mapfiles/transparent.png" draggable="false"
                                   style="width: 33px; height: 44px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                            </div>
                            <div title="" role="button" tabindex="-1"
                                 style="width: 33px; height: 44px; overflow: hidden; position: absolute; cursor: pointer; touch-action: none; left: -327px; top: 204px; z-index: 248;">
                              <img alt="" src="https://maps.gstatic.com/mapfiles/transparent.png" draggable="false"
                                   style="width: 33px; height: 44px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                            </div>
                            <div title="" role="button" tabindex="-1"
                                 style="width: 33px; height: 44px; overflow: hidden; position: absolute; cursor: pointer; touch-action: none; left: 332px; top: -281px; z-index: -237;">
                              <img alt="" src="https://maps.gstatic.com/mapfiles/transparent.png" draggable="false"
                                   style="width: 33px; height: 44px; user-select: none; border: 0px; padding: 0px; margin: 0px; max-width: none;">
                            </div>
                          </div>
                      ...
                      <div class="gmnoprint"
                        ...
                        <div class="gm-style-mtc" style="float: left; position: relative;">
                          <button draggable="false" aria-label="Show street map" title="Show street map" type="button"
                                  aria-pressed="true" id="3C97BAFF-3A6D-44AA-A518-74F39268B8DF" aria-expanded="false"
                          ...
                          <ul role="menu" aria-labelledby="3C97BAFF-3A6D-44AA-A518-74F39268B8DF"
                        ...
                        <div class="gm-style-mtc" style="float: left; position: relative;">
                          <button draggable="false" aria-label="Show satellite imagery" title="Show satellite imagery"
                                  type="button" aria-pressed="false" id="927C49AF-6AF6-43AB-9F96-43563C9765D7"
                                  aria-expanded="false"
                          ...
                          <ul role="menu" aria-labelledby="927C49AF-6AF6-43AB-9F96-43563C9765D7"
                    ...
                    <div>
                      <div
                        ...
                        <a target="_blank" rel="noopener"
                           href="https://maps.google.com/maps?ll=48.19581,9.910029&amp;z=5&amp;t=m&amp;hl=en-US&amp;gl=US&amp;mapclient=apiv3"
                      ...
                      <div draggable="false" class="gm-style-cc"
                        ...
                        <div
                          ...
                          <a target="_blank" rel="noopener" title="Report errors in the road map or imagery to Google"
                             dir="ltr"
                             href="https://www.google.com/maps/@48.1958096,9.9100294,5z/data=!10m1!1e1!12b1?source=apiv3&amp;rapsrc=apiv3"
...
export default {
  name: "coworking",
  components: {Newsletter, Footer, Navigation}
}
</script>
