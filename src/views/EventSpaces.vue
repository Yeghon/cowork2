        ...
        <div class="row pt-5">
          <div class="col-lg-5 order-lg-2">
            <div class="max-text mx-auto pt-4">
              ...
              <div class="line"></div>
              <h1 class="mt-2">Welcome all to host events with us</h1>
              <p>We have amenities to host your events. Our facilities are flexible to host any kind of event as you may request.
              </p>
<!--              <h4-->
