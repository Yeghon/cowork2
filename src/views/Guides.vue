    ...
    <main>
        ...
        <div class="container pt-5">
          <div class="row mb-lg-5">
            <div class="col-lg-5 mb-lg-0 mb-5">
              ...
              Intelligence to UX Design.</h4><h4>Discover the latest insights and emerging trends and how to apply them to
              your work.</h4></div>
            <div class="col-md-6 ml-auto d-lg-block d-none"><img
                src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2021/01/20210119_101420-900x720.jpg"
                class="w-100" alt="Guides"></div>
          </div>
        </div>
      </div>
      <div class="bg-light py-5">
        <div class="container py-lg-5">
          <div class="row">
            <div class="col-lg-5 mb-lg-0 mb-5"><img
                src="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2021/05/innovation-report-2020.jpg"
                class="w-100" alt="Talent Garden Last Report"></div>
      ...
      <div class="container mt-5 pt-5">
        <div class="col-12 px-0"><h3 class="mb-5">Browse Guide Categories</h3>
          <div class="controls controls-btn d-lg-flex align-items-center w-100">
            <button type="button" class="filter-btn my-2 mixitup-control-active" data-filter="all">All</button>
            <button type="button" class="filter-btn my-2" data-filter=".sustainability">Sustainability</button>
            <button type="button" class="filter-btn my-2" data-filter=".marketing">Marketing</button>
            <button type="button" class="filter-btn my-2" data-filter=".data">Data</button>
            <button type="button" class="filter-btn my-2" data-filter=".design">Design</button>
          </div>
        </div>
      </div>
              ...
              <div class="col-lg-3 col-md-4 col-sm-6 mb-5 mix post guides  sustainability">
                <div class="d-flex flex-column bg-light"><a href="#"
                  ...
                  <div class="p-4"><a href="#"> <span
                    ...
                    <p>The state of global foodtech report</p></a></div>
                </div>
              </div>
              <div class="col-lg-3 col-md-4 col-sm-6 mb-5 mix post guides  marketing">
                <div class="d-flex flex-column bg-light"><a
                  ...
                  <div class="p-4"><a href="#"> <span
                    ...
                    <p>From AAARRR to Whois, a glossary of terms most used by business growth experts.</p></a></div>
                </div>
              </div>
              <div class="col-lg-3 col-md-4 col-sm-6 mb-5 mix post guides  data">
                <div class="d-flex flex-column bg-light"><a
                  ...
                  <div class="p-4"><a href="#"> <span
                    ...
                    <p>Learn what it is and how to implement it.</p></a></div>
                </div>
              </div>
              <div class="col-lg-3 col-md-4 col-sm-6 mb-5 mix post guides  marketing">
                <div class="d-flex flex-column bg-light"><a
                  ...
                  <div class="p-4"><a href="#"> <span
                    ...
                    <p>The latest trends in Digital Marketing</p></a></div>
                </div>
              </div>
              <div class="col-lg-3 col-md-4 col-sm-6 mb-5 mix post guides  design">
                <div class="d-flex flex-column bg-light"><a
                  ...
                  <div class="effect-img"><img width="2560" height="2560"
                                               ...
                                               class="attachment-full size-full wp-post-image" alt="" loading="lazy"
                                               srcset="https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2021/04/Paper_1080x1080_HowDesignCanShape_2-scaled.jpg 2560w, https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2021/04/Paper_1080x1080_HowDesignCanShape_2-300x300.jpg 300w, https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2021/04/Paper_1080x1080_HowDesignCanShape_2-1024x1024.jpg 1024w, https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2021/04/Paper_1080x1080_HowDesignCanShape_2-150x150.jpg 150w, https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2021/04/Paper_1080x1080_HowDesignCanShape_2-768x768.jpg 768w, https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2021/04/Paper_1080x1080_HowDesignCanShape_2-1536x1536.jpg 1536w, https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2021/04/Paper_1080x1080_HowDesignCanShape_2-2048x2048.jpg 2048w, https://334045-1026637-1-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2021/04/Paper_1080x1080_HowDesignCanShape_2-600x600.jpg 600w"
                  ...
                  <div class="p-4"><a
                    ...
                    Future</h6>
                    <p>For the Environment, Society and Business</p></a></div>
                </div>
              </div>
              <div class="col-lg-3 col-md-4 col-sm-6 mb-5 mix post guides  design">
                <div class="d-flex flex-column bg-light"><a
                  ...
                  <div class="p-4"><a href="#"> <span
                    ...
                    <p>30+ fundamental &amp; emerging terms you need to know</p></a></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="wrapper-flex">
        <div class="bg-dark cta py-5" id="row-0">
